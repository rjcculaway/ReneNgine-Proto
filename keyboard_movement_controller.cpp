...
namespace rne {
	void KeyboardMovementController::moveInPlaneXZ(GLFWwindow* window, float dt, RneGameObject& gameObject) {
		...
		gameObject.transform.rotation.x = glm::clamp(gameObject.transform.rotation.x, -1.5f, 1.5f); // limit pitch values
